...
const FeatureBox = (props) => {
  ...
  return (
    <>
      ...
      <h1 align="center">OUR MOST POPULAR DISHES</h1>
      <Grid item xs={12} md={12} lg={12} className="resturant">
        {/* <Container> */}
        <Grid item xs={3}  >
          <Card className={classes.root}>
            <CardActionArea>
              <img width="250px" height="190px" className="restaurant-image"
...

      {
        props.features.map((feature, key) =>
          (feature.id % 2 !== 0) ?
            <Row key={key} className={feature.id === 2 ? "align-items-center" : "align-items-center mt-5"}>
              <Col md={5} >
                <div>
...
const Feature = () => {
  ...
  return (
    ...
    <section className="section" id="feature">
      <Container>
        {/* <Row className="justify-content-center" paddingTop="200px">
          <Col lg={6} md={8}>
        ...
        <FeatureBox features={resturants} />
      </Container>
      ...
      <section class="section1">
        ...
        <h1 align="center">WHAT OUR CUSTOMERS SAY ABOUT US</h1>
        <Grid item xs={12} md={6} lg={12} className="resturant">
          {/* <Container> */}
          <Grid item xs={3}   >
            <Card height="200px" width="100px"  >
              <CardActionArea>
                <img width="60px" height="60px" class="image"
                  // className={classes.media}
                ...
                <img width="120px" height="70px" class="image1"
                  // className={classes.media}
